...
srcs=['dataWithTime/split_train.ffm','dataWithTime/split_test.ffm','dataWithTime/click_test.ffm']
dess=['dataTimeNormal/split_train.ffm','dataTimeNormal/split_test.ffm','dataTimeNormal/click_test.ffm']
