...
def getUserDict(doc_dict,uuid_set):
...
def createFeat(src,des,doc_dict,uuid_dict,event_dict,prcont_dict):
    inFile=open(src)
    next(inFile)
    outFile=open(des,'w')
...
def userHobby():
    ...
    doc_dict=loadDoc()
    uuid_dict=getUserDict(doc_dict,uuid_set)
    train='data/click_train.csv'
    test='data/click_test.csv'
    trainFeat='userHobby/data/new_train_nonormal.csv'
    testFeat='userHobby/data/new_test_nonormal.csv'
    prcont_dict=loadPrcont()
    createFeat(train,trainFeat,doc_dict,uuid_dict,event_dict,prcont_dict)
    createFeat(test,testFeat,doc_dict,uuid_dict,event_dict,prcont_dict)
